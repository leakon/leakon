...
class SofavDB_Record {
	...
	public static function findAll(SofavDB_Table $tableObject, SofavDB_Criteria $criteria, $findObject = true) {
		...
		$statement		= SofavDB_Manager::getConnection()->prepare($strSQL);
	...
	protected static function catchError($bool = false) {

		$errroInfo	= array();
		if (!$bool) {
			$errroInfo	= SofavDB_Manager::getConnection()->errorInfo();
		}
